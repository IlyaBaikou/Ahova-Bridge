namespace Ahova.Bridge.Configuration;
...
public sealed class LocalStorageOptions
{
    ...
    public string Prefix { get; init; } = "ahova";
...
public static class BridgeOptionsRules
{
    public static IReadOnlyList<string> Validate(BridgeOptions options)
    {
        ...
        if (options.Ai.Enabled)
        {
            ...
            if (options.Ai.AllowedModels.Count == 0)
                errors.Add("Choose at least one local AI model.");
