...
namespace Ahova.Bridge.Capabilities.Storage;
    ...
    : ILocalStorageClient
{
    ...
    private const string MountMarkerName = ".ahova-bridge-mount-id";
    ...
    private static string Resolve(string root, string relativePath)
    {
        ...
        if (relativePath.Split(
            ...
            .Any(segment => segment.StartsWith(".ahova-bridge-", StringComparison.Ordinal)))
